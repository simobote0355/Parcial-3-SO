...
public:
    ...
    // Método para encriptar un archivo comprimido usando el cifrado de César
    bool encryptFile(const std::string& compressedFilePath, const std::string& encryptedFilePath, int shift);

    // Método para desencriptar un archivo encriptado usando el cifrado de César
    bool decryptFile(const std::string& encryptedFilePath, const std::string& decryptedFilePath, int shift);

    bool compressAndEncrypt(const std::string& inputFilePath, const std::string& compressedFilePath, const std::string& encryptedFilePath, int shift);

    bool encryptAndCompress(const std::string& inputFilePath, const std::string& encryptedFilePath, const std::string& compressedFilePath, int shift);
